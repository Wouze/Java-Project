...
public class JFrame2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(167, 241, 241));
        jPanel1.setForeground(new java.awt.Color(0, 102, 102));
        jPanel1.setToolTipText("AI cinema");
        ...
        jLabel1.setText("Welcome To AI Cinema");

        jLabel2.setFont(new java.awt.Font("Segoe UI Historic", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 102, 102));
        jLabel2.setText("Please Click Your Choice ....");

        jButton1.setFont(new java.awt.Font("Segoe Print", 0, 48)); // NOI18N
        ...
        jButton2.setFont(new java.awt.Font("Segoe Print", 0, 48)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       LogAndSign  logandsign = new LogAndSign ();
       logandsign.show();
       dispose();
