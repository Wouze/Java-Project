...
public class hallBooking extends Booking{
    String hallType;
       ...
       public void printHallBooking(int index){
           ...
           System.out.println("Movie:"+movies2[index].getName());
           System.out.println("Genra:"+movies2[index].Genra);
    ...
    public String toString() {
        ...
        return String.format("Hall Ticket \n Movie : %s\n Hall Type : %s\n Total Price : %.2f", super.movies2[super.getMovieId()].getName() , getHallType() ,super.getPrice() );
    }
